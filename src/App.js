    ...
    <div className="wrapper clear">
      ...
      <div className="content">
        ...
        <div className="sneakers">
          <div className="card">
            <button className="card__like card-button">
            ...
            <img className="card__image" src="/img/sneakers/1.jpg" alt="" />
            ...
            <div className="card__price">
              <div className="card__price-content">
                ...
                <span className="card__price-content--value">12 999 руб.</span>
              </div>
              <button className="card__price-append card-button">
                <img className="card__append-image" src="/img/plus.svg" alt="" />
              </button>
            </div>
          </div>
          {/* card */}
          <div className="card">
            ...
            <img className="card__image" src="/img/sneakers/2.jpg" alt="" />
            <p className="card__title">Мужские Кроссовки Nike Air Max 270</p>
            <div className="card__price">
              <div className="card__price-content">
                <span className="card__price-content--text">Цена:</span>
                <span className="card__price-content--value">12 999 руб.</span>
          ...
          <div className="card">
            ...
            <img className="card__image" src="/img/sneakers/3.jpg" alt="" />
            <p className="card__title">Мужские Кроссовки Nike Blazer Mid Suede</p>
            <div className="card__price">
              <div className="card__price-content">
                <span className="card__price-content--text">Цена:</span>
          ...
          <div className="card">
            ...
            <img className="card__image" src="/img/sneakers/4.jpg" alt="" />
            <p className="card__title">Кроссовки Puma X Aka Boku Future Rider</p>
            <div className="card__price">
              <div className="card__price-content">
                <span className="card__price-content--text">Цена:</span>
                <span className="card__price-content--value">12 999 руб.</span>
